codeunit 50012 "Drop Area Mgt. Return"
{
    ...
    begin
        ...
        SecurityReturn."File Name" := CurrentFilename;;
        SecurityReturn.Attachment.CREATEOUTSTREAM(OStream);
        ToMemoryStream.WriteTo(OStream);
        SecurityReturn.MODIFY;
    ...
    begin
        ...
        SecurityReturn.CALCFIELDS(Attachment);
        TempBlob.Blob := SecurityReturn.Attachment;
        FileMgt.BLOBExport(TempBlob,SecurityReturn."File Name",TRUE);
    end;
}
