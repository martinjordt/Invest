codeunit 70110 "Drop Area Mgt. Journal Line"
{
    ...
    begin
        ...
        SecurityJnlLine."File Name" := CurrentFilename;;
        SecurityJnlLine.Attachment.CREATEOUTSTREAM(OStream);
        ToMemoryStream.WriteTo(OStream);
        SecurityJnlLine.MODIFY;
    ...
    begin
        ...
        TempBlob.Blob := SecurityJournalLine.Attachment;
        FileMgt.BLOBExport(TempBlob,SecurityJournalLine."File Name",TRUE);
    end;
}
